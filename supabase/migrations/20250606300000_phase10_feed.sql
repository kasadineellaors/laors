-- LAORS Phase 10: Treatment reason, feed rations, feeding records
...
CREATE INDEX IF NOT EXISTS feed_rations_org_idx
  ON public.feed_rations(organization_id);
...
CREATE INDEX IF NOT EXISTS feeding_records_org_idx
  ON public.feeding_records(organization_id);
CREATE INDEX IF NOT EXISTS feeding_records_fed_idx
  ON public.feeding_records(organization_id, fed_at DESC);
CREATE INDEX IF NOT EXISTS feeding_records_group_idx
  ON public.feeding_records(cattle_group_id);
